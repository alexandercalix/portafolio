  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (imageFiles.length > 0) {
        addLog('info', `Queueing ${imageFiles.length} image payloads for upload...`)
      ...
      addLog('success', 'Project created successfully. Rerouting...')
  ...
  return (
    <div className="space-y-8 pb-12">
      <div className="flex items-center gap-4">
        <Link href="/admin/projects" className="p-2 bg-white dark:bg-[#111315] border border-neutral-200 dark:border-neutral-800 rounded hover:bg-neutral-200 dark:bg-neutral-800 transition-colors text-neutral-600 dark:text-neutral-400">
          <ArrowLeft className="w-5 h-5" />
        </Link>
        <div>
          <h1 className="text-3xl font-bold tracking-tight text-neutral-900 dark:text-neutral-100">Initialize Project</h1>
      ...
      <form onSubmit={handleSubmit} className="grid grid-cols-1 xl:grid-cols-4 gap-8">
        ...
        <div className="xl:col-span-3 space-y-6 bg-white dark:bg-[#111315] p-6 rounded-lg border border-neutral-200 dark:border-neutral-800">
          ...
          <div className="space-y-2">
            ...
            <input
              ...
              placeholder="e.g. Serverless Analytics Pipeline"
            />
          </div>
          ...
          <div className="space-y-2">
            ...
            <input
              ...
              placeholder="React, C#, Azure Functions, MongoDB"
            />
          </div>
        </div>
        ...
        <div className="space-y-6">
          <div className="bg-white dark:bg-[#111315] p-6 rounded-lg border border-neutral-200 dark:border-neutral-800 space-y-6">
            ...
            <div className="space-y-2">
              <label className="font-mono text-xs text-neutral-500 uppercase">Screenshot_Array</label>
              <div 
